...
class Pokedex extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      requestRoot: "https://raw.githubusercontent.com/RedPillPhil/api-data/master/data/api/v2/pokemon/",
  ...
  changePokemon() {
    ...
    then(data => {
      ...
      then(response => response.json()).
      then(data => {
        const api = "https://raw.githubusercontent.com/RedPillPhil/api-data/master/data/api/v2/pokemon/";
