...
class Pokedex extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      requestRoot: "https://chipper-muffin-c6de8e.netlify.app/api-data/data/api/v2/pokemon/",
  ...
  changePokemon() {
    ...
    then(data => {
      ...
      then(response => response.json()).
      then(data => {
        const api = "https://chipper-muffin-c6de8e.netlify.app/api-data/data/api/v2/pokemon/";
